<main class="contenedor seccion">
    ...
    <?php if($mensaje){ ?>
            <p data-cy="alerta-formulario" class='alerta exito'><?php echo $mensaje; ?></p>";
        <?php } ?>
    ...
    <form data-cy="formulario-contacto" class="formulario" action="/contacto" method="POST">
        <fieldset>
            ...
            <input data-cy="input-nombre" type="text" placeholder="Tu Nombre" id="nombre" name="contacto[nombre]" require>
        ...
        <fieldset>
            ...
            <select data-cy="input-opciones" id="opciones" name="contacto[tipo]" require>
            ...
            <input data-cy="input-precio" type="number" placeholder="Tu Precio o Presupuesto" id="presupuesto" name="contacto[precio]" require>
